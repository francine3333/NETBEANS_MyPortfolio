 ...
 * @author Francine
 */
public class CalculatorGUII extends javax.swing.JFrame {

    /**
     * Creates new form CalculatorGUII
     */
    public CalculatorGUII() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setBackground(new java.awt.Color(255, 51, 153));
        ...
        jLabel1.setText("Mini Calculator by Rischa Francine C. Lastimosa");
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jButton13, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    if (parts.length != 2) {
        // Invalid expression, handle the error
        return;
    }
    ...
    switch (expression.charAt(parts[0].length())) {
        case '+':
        ...
        case '/':
            if (secondNumber != 0) {
                ...
                // Division by zero, handle the error
                return;
            }
            break;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculatorGUII.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculatorGUII().setVisible(true);
            }
        });
    }
